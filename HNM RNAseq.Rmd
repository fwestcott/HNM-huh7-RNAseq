...
graph <- Avg.gene_expression.pivot %>%
  dplyr::filter(grepl('KRT18', geneID))
...
dotplot(HvL_kk, showCategory = 5, title = "HvL Enriched Pathways vs Control" , split=".sign") + facet_grid(.~.sign)
...
dotplot(LPvLC_kk, showCategory = 5, title = "LPvLC Enriched Pathways vs Control" , split=".sign") + facet_grid(.~.sign)
...
dotplot(HOvHC_kk, showCategory = 5, title = "HOvHC Enriched Pathways vs Control" , split=".sign") + facet_grid(.~.sign)
...
dotplot(HPvHC_kk, showCategory = 5, title = "HPvHC Enriched Pathways vs Control" , split=".sign") + facet_grid(.~.sign)
