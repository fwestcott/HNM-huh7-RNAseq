...
group <- factor(samplemetadata$Condition, levels = c("Low_Insulin_Control", "Low_Insulin_OPLA", "Low_Insulin_POLA", "High_Insulin_Control", "High_Insulin_OPLA", "High_Insulin_POLA"))
